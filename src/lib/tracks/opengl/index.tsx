...
export const openGLChapters: Chapter[] = [
  ...
  { id: "light-casters",   section: LIGHTING,        title: "Light Casters",             minRead: 14, load: () => import("./chapters/lighting-basics/light-casters").then((m) => m.LightCastersContent) },
  { id: "multiple-lights", section: LIGHTING,        title: "Multiple Lights",           minRead: 9,  load: () => import("./chapters/lighting-basics/multiple-lights").then((m) => m.MultipleLightsContent) },

  { id: "advanced-lighting", section: ADV_LIGHTING,  title: "Blinn-Phong",               minRead: 9,  load: () => import("./chapters/lighting-advanced/advanced-lighting").then((m) => m.BlinnPhongContent) },
  { id: "gamma",           section: ADV_LIGHTING,    title: "Gamma Correction",          minRead: 10, load: () => import("./chapters/lighting-advanced/gamma").then((m) => m.GammaContent) },
  { id: "shadow-mapping",  section: ADV_LIGHTING,    title: "Shadow Mapping",            minRead: 14, load: () => import("./chapters/lighting-advanced/shadow-mapping").then((m) => m.ShadowMappingContent) },
  { id: "point-shadows",   section: ADV_LIGHTING,    title: "Point Shadows",             minRead: 10, load: () => import("./chapters/lighting-advanced/point-shadows").then((m) => m.PointShadowsContent) },
  ...
  { id: "normal-mapping",  section: ADV_LIGHTING,    title: "Normal Mapping",            minRead: 12, load: () => import("./chapters/lighting-advanced/normal-mapping").then((m) => m.NormalMappingContent) },
  { id: "hdr",             section: ADV_LIGHTING,    title: "HDR & Tone Mapping",        minRead: 10, load: () => import("./chapters/lighting-advanced/hdr").then((m) => m.HdrContent) },
  { id: "bloom",           section: ADV_LIGHTING,    title: "Bloom",                     minRead: 10, load: () => import("./chapters/lighting-advanced/bloom").then((m) => m.BloomContent) },
  ...
  { id: "deferred",        section: ADV_LIGHTING,    title: "Deferred Shading",          minRead: 12, load: () => import("./chapters/lighting-advanced/deferred").then((m) => m.DeferredContent) },
  ...
  // ── PBR ──────────────────────────────────────────────────────────────────
  { id: "pbr-theory",      section: PBR,             title: "PBR Theory",                minRead: 16, load: () => import("./chapters/pbr/pbr-theory").then((m) => m.PbrTheoryContent) },
  { id: "pbr-lighting",    section: PBR,             title: "Cook-Torrance Lighting",    minRead: 16, load: () => import("./chapters/pbr/pbr-lighting").then((m) => m.PbrLightingContent) },
  { id: "ibl-diffuse",     section: PBR,             title: "IBL: Diffuse Irradiance",   minRead: 13, load: () => import("./chapters/pbr/ibl-diffuse").then((m) => m.IblDiffuseContent) },
