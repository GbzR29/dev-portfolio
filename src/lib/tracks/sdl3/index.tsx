...
export const sdl3Track: Track = {
  ...
  chapters: [
    { id: "whats-new", title: "SDL3 vs SDL2",              minRead: 9,  content: (t) => <WhatsNewContent  t={t} /> },
    { id: "setup",     title: "Setup & First Window",      minRead: 10, content: (t) => <SetupContent     t={t} /> },
    { id: "main-loop", title: "The Main Loop",             minRead: 11, content: (t) => <MainLoopContent  t={t} /> },
    { id: "input",     title: "Events & Input",            minRead: 12, content: (t) => <InputContent     t={t} /> },
    { id: "renderer",  title: "The 2D Renderer",           minRead: 10, content: (t) => <RendererContent  t={t} /> },
    { id: "textures",  title: "Textures & Images",         minRead: 11, content: (t) => <TexturesContent  t={t} /> },
    { id: "text",      title: "Text with SDL3_ttf",        minRead: 9,  content: (t) => <TextContent      t={t} /> },
    { id: "audio",     title: "Audio Streams",             minRead: 10, content: (t) => <AudioContent     t={t} /> },
    { id: "gpu",       title: "SDL_GPU — Modern Graphics", minRead: 14, content: (t) => <GpuContent       t={t} /> },
    { id: "platform",  title: "Time, Files & Shipping",    minRead: 11, content: (t) => <PlatformContent  t={t} /> },
  ],
};
