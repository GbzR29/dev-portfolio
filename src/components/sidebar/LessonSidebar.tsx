...
import {
  Aperture, BookMarked, Boxes, Braces, Calculator, CheckCircle2, ChevronRight, Clock, Crosshair, Divide, Gauge, Hash, Layers, Mountain, MoveUpRight, Puzzle, Radar, Shapes, Timer, Variable, Wand, Waves, Lightbulb, Move3d, Rocket, Sparkles, Wrench,
  type LucideIcon,
} from "lucide-react";
...
const TRACK_SECTION_ICONS: Record<string, [RegExp, LucideIcon][]> = {
  math: [[/arithmetic/i, Divide], [/algebra/i, Variable], [/foundation/i, Calculator], [/vector/i, MoveUpRight]],
};
