  ...
  return (
    <Figure
      ...
      note={mode === "change"
        ...
        : mode === "remap"
          ? tx(t, "figRat_noteRemap", "Drag x. The first step asks what fraction of the way from a to b x is: t = (x − a)/(b − a), 0 at a, 1 at b, 50 % halfway. The second step walks the same fraction of the way from c to d. Here the default maps an enemy's distance, 2 to 10 m, to a sound volume from 1 down to 0: the ranges can point in opposite directions. Turn clamping off and drag past a or b: t leaves 0–100 % and the output overshoots, which is usually why a health bar draws outside its frame.")
